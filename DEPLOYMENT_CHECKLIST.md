# 🚀 IntelliFlow Platform — Enterprise Deployment Checklist
...
| **LLM Provider** | OpenAI API | Paid Pay-as-you-go | `text-embedding-3-small` (1536-dim) & `gpt-4o-mini` |
...
3. **Deploy FastAPI AI Service on Render**: Deploy `Dockerfile.ai` with `OPENAI_API_KEY`.
...
- [ ] Verify Flyway migration `V1__init_schema.sql` successfully executed and created HNSW vector index.
